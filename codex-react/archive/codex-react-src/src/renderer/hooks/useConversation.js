 ...
 *
 * 内部通过 ConversationManager.addConversationCallback() 订阅变更
...
export function useConversation(conversationId) {
    ...
    useEffect(() => {
        ...
        // 订阅变更回调
        const unsubscribe = conversationManager.addConversationCallback(conversationId, (newState) => {
            setState(newState);
        });
...
export function useConversationManager() {
    return useContext(ConversationManagerContext);
}
