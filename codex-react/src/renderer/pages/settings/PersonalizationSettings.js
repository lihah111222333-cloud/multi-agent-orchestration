...
function PersonalityDropdown({ options, selected, onSelect, disabled }) {
    return (
        <select
            className="bg-token-background-secondary text-token-foreground rounded-md border border-token-border px-2.5 py-1.5 text-sm outline-none"
                        ...
                        <div className="flex flex-col gap-3">
                            {isInitialLoad ? (
                                ...
                                <textarea
                                    ...
                                    className="bg-token-background-secondary text-token-foreground font-mono w-full rounded-md border border-token-border px-2.5 py-2 text-sm outline-none resize-y"
                                    disabled={!isReady || saveMutation.isPending}
