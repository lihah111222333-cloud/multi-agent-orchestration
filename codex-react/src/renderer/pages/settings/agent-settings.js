...
export default function AgentSettingsPage() {
    ...
    const models = [
        ...
        { id: "codex-mini-latest", name: "codex-mini", description: "Optimized for Codex" },
    ];
    ...
    return (
        <div className="agent-settings flex flex-col gap-8">
            ...
            <SettingsSection title="Custom Instructions" description="Additional instructions for the AI agent">
                <textarea
                    className="w-full h-32 bg-token-background-secondary rounded-lg p-3 text-sm text-token-foreground border border-token-border resize-y outline-none"
