    ...
    const handleClearHistory = useCallback(async () => {
        ...
        try {
            await bridge.sendRequest({
                id: `threads-clear-${Date.now()}`,
                method: "threads/clearAll",
                params: {},
            });
        } catch (err) {
        ...
        <div className="data-controls flex flex-col gap-8">
            ...
            <div className="settings-section">
                ...
                <div className="flex items-center gap-2">
                    <input
                        className="flex-1 bg-token-background-secondary border border-token-border rounded-md px-3 py-2 text-sm text-token-foreground font-mono"
