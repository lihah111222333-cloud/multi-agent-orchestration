    ...
    return (
        <Toolbar electron>
            <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                {model && (
                    <span className="text-xs text-token-description-foreground bg-token-bg-secondary px-2 py-0.5 rounded">
                        {model}
                    </span>
                )}
            </div>
    ...
    return (
        <div className="skills-filter-bar px-4 py-2 border-b border-token-border">
            <input
                ...
                className="w-full bg-token-bg-secondary rounded-md px-3 py-1.5 text-sm text-token-foreground placeholder-token-input-placeholder-foreground outline-none"
            />
        </div>
    );
}
