    ...
    return (
        <SettingsPage title={<SettingsSlug slug="git-settings" />}>
                ...
                <Card.Content>
                    <SettingsList>
                        <SettingsRow
                            ...
                            control={
                                <input
                                    className="bg-token-bg-secondary text-token-foreground w-56 rounded-md border border-token-border px-2.5 py-1.5 text-sm outline-none"
            ...
            <Card>
                ...
                <Card.Content>
                    <textarea
                        className="w-full bg-token-bg-secondary text-token-foreground rounded-md border border-token-border px-2.5 py-2 text-sm outline-none resize-y"
                        value={displayCommit}
