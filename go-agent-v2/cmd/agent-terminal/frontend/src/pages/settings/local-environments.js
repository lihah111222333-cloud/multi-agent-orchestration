    ...
    return (
        <div className="local-environments flex flex-col gap-8">
            ...
            <div className="settings-section">
                ...
                <select
                    className="bg-token-bg-secondary border border-token-border rounded-md px-3 py-2 text-sm text-token-foreground"
            ...
            <div className="settings-section">
                ...
                <textarea
                    className="w-full h-32 bg-token-bg-secondary border border-token-border rounded-lg p-3 text-sm text-token-foreground font-mono resize-y outline-none"
            ...
            <div className="settings-section">
                ...
                <textarea
                    className="w-full h-24 bg-token-bg-secondary border border-token-border rounded-lg p-3 text-sm text-token-foreground font-mono resize-y outline-none"
