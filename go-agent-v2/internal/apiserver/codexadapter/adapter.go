...
func (a *Adapter) runtimeConsumerDeps() consumerruntime.Deps {
	...
	return consumerruntime.Deps{
		...
		CollectAutoMatchedSkillMatch:   promptsvc.CollectAutoMatchedSkillMatches,
		...
		IsHistoricalResumeCandidateErr: lifecyclesvc.IsHistoricalResumeCandidateError,
...
func (a *Adapter) ThreadExistsInHistory(ctx context.Context, threadID string) bool {
	return historyconsumer.ThreadExistsInHistory(ctx, threadID, 0, lifecyclesvc.IsLikelyCodexThreadID, a.bindingExists, a.agentStatusExists, a.loadThreadArchiveMap)
}
