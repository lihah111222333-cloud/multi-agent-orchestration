...
func skillsLocalReadTyped(s *Server, ctx context.Context, p skillsruntime.SkillsLocalReadParams) (any, error) { return skillsManagerDelegate(s).SkillsLocalRead(ctx, p) }
func skillsLocalImportDirTyped(s *Server, ctx context.Context, p skillsruntime.SkillsLocalImportDirParams) (any, error) { return skillsManagerDelegate(s).SkillsLocalImportDir(ctx, p) }
func skillsLocalDeleteTyped(s *Server, ctx context.Context, p skillsruntime.SkillsLocalDeleteParams) (any, error)       { return skillsManagerDelegate(s).SkillsLocalDelete(ctx, p) }
func skillsMatchPreviewTyped(s *Server, ctx context.Context, p skillsruntime.SkillsMatchPreviewParams) (any, error)     { return skillsManagerDelegate(s).SkillsMatchPreview(ctx, p) }
func skillsConfigReadTyped(s *Server, ctx context.Context, p skillsruntime.SkillsConfigReadParams) (any, error)         { return skillsManagerDelegate(s).SkillsConfigRead(ctx, p) }
func skillsConfigWriteTyped(s *Server, ctx context.Context, p skillsruntime.SkillsConfigWriteParams) (any, error)       { return skillsManagerDelegate(s).SkillsConfigWrite(ctx, p) }
func skillsSummaryWriteTyped(s *Server, ctx context.Context, p skillsruntime.SkillsSummaryWriteParams) (any, error)     { return skillsManagerDelegate(s).SkillsSummaryWrite(ctx, p) }
func skillsRemoteReadTyped(s *Server, ctx context.Context, p skillsruntime.SkillsRemoteReadParams) (any, error)         { return skillsManagerDelegate(s).SkillsRemoteRead(ctx, p) }
func skillsRemoteWriteTyped(s *Server, ctx context.Context, p skillsruntime.SkillsRemoteWriteParams) (any, error)       { return skillsManagerDelegate(s).SkillsRemoteWrite(ctx, p) }
