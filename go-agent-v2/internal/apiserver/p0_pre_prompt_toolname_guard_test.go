...
func p0PreModeAPIServerPrompt() string {
...
func TestP0PrePromptToolnameGuard(t *testing.T) {
	if p0PreModeAPIServerPrompt() != "pre" {
	...
	if totalHits == 0 {
		t.Fatalf("p0-pre expects legacy tool names to be discoverable in targets, got 0 hits")
	}
}
