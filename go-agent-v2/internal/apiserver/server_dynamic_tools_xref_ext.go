...
func init() {
	registerExtendedLSPDynamicToolProvider(
		"xref.tools",
		func(s *Server) {
			s.dynTools["lsp_workspace_symbol"] = s.lspTools.WorkspaceSymbol
			s.dynTools["lsp_implementation"] = s.lspTools.Implementation
			s.dynTools["lsp_type_definition"] = s.lspTools.TypeDefinition
		},
