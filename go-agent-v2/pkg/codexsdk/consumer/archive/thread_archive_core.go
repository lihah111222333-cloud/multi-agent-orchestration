...
type threadArchiveFile = servicearchive.ThreadArchiveFile

type threadArchiveManifest = servicearchive.ThreadArchiveManifest

type threadArtifactCandidate = servicearchive.ThreadArtifactCandidate
...
type threadArchiveRestoreNotice = servicearchive.ThreadArchiveRestoreNotice
