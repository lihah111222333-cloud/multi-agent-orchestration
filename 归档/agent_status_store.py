...
GO:migrate → go/internal/store/agent_status.go
GO:target  → Go sqlx (结构与 shared_file_store 类似)
GO:notes:
  - _row_to_agent_status → Go struct AgentStatus `db:"col"` (消除)
  - _normalize_* 系列 → Go 编译时类型检查
"""
