...
GO:migrate → go/internal/store/shared_file.go
GO:target  → Go sqlx CRUD (最简模块, ~40 行 Go)
GO:notes:
  - _row_to_file → Go struct SharedFile `db:"col"` (消除)
  - _normalize_path → Go filepath.Clean 等价
  - 4 个 CRUD 函数 → sqlx 1 行/查询
"""
