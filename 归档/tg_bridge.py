...
GO:migrate → go/internal/telegram/bridge.go
GO:target  → go-telegram-bot-api
GO:notes:
  - python-telegram-bot → Go go-telegram-bot-api
  - _on_message → Go Update handler
  - start_tg_bridge → Go goroutine
"""
