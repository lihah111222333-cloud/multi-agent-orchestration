...
GO:migrate → go/internal/util/
GO:target  → Go stdlib
GO:notes:
  - escape_like → Go func EscapeLike(s string) string (~5 行)
  - normalize_limit → Go func ClampInt(v, lo, hi int) int
  - as_int_env / as_float_env → Go os.Getenv + strconv
"""
